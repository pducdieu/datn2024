                        ...
                        <div class="row">
                            ...
                            <form method="GET" action="cart.php">
                                ...
                                <div class="uudai my-3">
                                    <h6 class="header font-weight-bold">Khuyến mãi & Ưu đãi tại Rose Shop:</h6>
                                    <ul>
                            ...
                            <div class="col-md-5">
                                <div class="thongtinsach">
                                    <ul>
                                        <li> <span class="header font-weight-bold">Khi mua tại Rose Shop quý khác sẽ được:</span></li>
                                        <li><b>Miễn phí giao hàng </b>cho đơn hàng từ 1.500.000đ ở Hà Nội và 2.000.000đ ở
                                            Tỉnh/Thành khác</li>
