...
<?Php
    ...
    foreach ($_SESSION['cart'] as $value) {
        $result = mysqli_query($con, "INSERT INTO `orders_detail`(`order_id`,`product_id`,`product_name`,`quantity`,`image`,`price`,`time`) VALUES ('$orderid', '" . $value['id'] . "','" . $value['name'] . "','" . $value['quantity'] . "','" . $value['image'] . "' ,'" . $value['price'] . "','" . time() . "')");
    }
}
